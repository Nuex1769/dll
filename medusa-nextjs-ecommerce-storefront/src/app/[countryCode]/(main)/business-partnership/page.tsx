...
const partnerTypes = [
  {
    ...
    description:
      "Carry DLL products in your store. We offer competitive wholesale pricing, marketing support, and dedicated account management for retail partners.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Become a DLL distributor in your region. We're expanding globally and looking for distribution partners who share our passion for cycling safety.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
  ...
  },
  {
    title: "Co-Branding",
    description:
      "Create custom-branded DLL helmets for your team, company, or event. Perfect for delivery fleets, cycling clubs, and corporate wellness programs.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
    ...
    <div className="content-container py-16 small:py-24">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 small:mb-24">
        ...
        <p className="mt-6 text-base small:text-lg text-dll-foreground-secondary leading-relaxed">
          We&apos;re looking for partners who share our vision for smarter, safer
          cycling. Whether you&apos;re a retailer, distributor, or brand — let&apos;s
      ...
      <div className="text-center bg-dll-bg-secondary rounded-2xl p-12 small:p-16 max-w-3xl mx-auto">
        ...
        <p className="text-sm text-dll-foreground-secondary mb-8 max-w-lg mx-auto">
          Reach out to our partnerships team and we&apos;ll get back to you within
          2 business days.
        </p>
        <a
          href="mailto:partnerships@dll.com"
